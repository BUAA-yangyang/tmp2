...
class FinalZeroMonitorTest(unittest.TestCase):
    ...
    def test_freshness_and_time_since_nonzero_are_independent(self):
        self.monitor.observe(10.00, (0.2, 0.0, 0.0))
        self.monitor.observe(10.10, (0.0, 0.0, 0.0))
        self.monitor.observe(10.55, (0.0, 0.0, 0.0))
    ...
    def test_fresh_zero_without_settle_interval_fails(self):
        self.monitor.observe(2.0, (0.1, 0.0, 0.0))
        self.monitor.observe(2.4, (0.0, 0.0, 0.0))
        self.monitor.observe(2.45, (0.0, 0.0, 0.0))
    ...
    def test_clock_rollback_fails_closed(self):
        self.monitor.observe(8.0, (0.0, 0.0, 0.0))
        self.monitor.observe(7.9, (0.0, 0.0, 0.0))
    ...
    def test_evaluate_time_rollback_fails_closed(self):
        self.monitor.observe(5.0, (0.0, 0.0, 0.0))
    ...
    def test_nonfinite_command_fails_closed(self):
        self.monitor.observe(1.0, (float("nan"), 0.0, 0.0))
