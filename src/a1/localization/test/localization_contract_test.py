...
class LocalizationContractTest(unittest.TestCase):
    ...
    def test_standard_frame_contract(self):
        ...
        self.assertIn("world_alignment_enabled: true", frames)
        self.assertIn("world_frame: world", frames)
        self.assertIn("initial_world_to_base_translation: [0.0, -3.2, 0.6]", frames)
    ...
    def test_online_map_product_contract(self):
        ...
        self.assertIn("expected_frame: world", config)
        self.assertIn("alignment_mode: fixed_start", config)
        self.assertIn("configured_world_start_translation: [0.0, -3.2, 0.6]", config)
